...
export class SubscriptionService {
    ...
    async createSubscription(userId: string, email: string, role: string, country: string) {
    ...
    async changeSubscription(userId: string, subscriptionId: string, newRole: string, newCountry: string) {
        const subRef = db.collection('subscriptions').doc(subscriptionId);
        const subDoc = await subRef.get();
